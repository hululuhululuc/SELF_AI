...
- Local runtime benchmark logs and raw run artifacts (for example `benchmarks/runs/` and memory-eval raw traces)
...
- Large local model files and local run logs are excluded from this repository by design.
